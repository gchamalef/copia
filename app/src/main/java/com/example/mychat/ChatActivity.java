...
public class ChatActivity extends AppCompatActivity {
    ...
    void callApi(JSONObject jsonObject){
        ...
        Request request = new Request.Builder()
                .url(url)
                .post(body)
                .header("Authorization","Bearer AAAAoLgHO0Y:APA91bG_tOafxATUdmbvtCa_14d7IRMVXX8Bf2GptyNN6q8akY-xMnVomK4PBn3wre6F7g_O6-msBTxScF_UdM4_760fr52GUpTlK0oqwOS5KjYx3v33wvGe81Krl0ob-ga_ddooXgGN")
                .build();
